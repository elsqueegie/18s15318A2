...
After tuning, a K-fold cross validation was performed on the training dataset. Performance on the holdout set is explored in the results section. The in-sample performance was tracked to see the performance of the AdamOptimizer algorithm. This is shown below:
...
The confusion matrix of each classifier shows its strengths and weaknesses.
\begin{figure}[h]
...
The confusion matrices are in sync with the accuracy results outlined previously. 
